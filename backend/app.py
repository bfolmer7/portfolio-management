...
def create_app():
    ...
    app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://admin:Veritas@localhost/investmentportfoliomanager'
    app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False
    app.config['SESSION_COOKIE_NAME'] = 'investmentportfoliomanager'  
